      ...
      <div className="center grid">
        <img className="p-2 w-16 pointer-events-none" src={logo} alt="4dchan.org" />
            ...
            <div className="p-1 text-left">
              <div className="p-2">
                To use 4dchan.org, you understand and agree to the following:
              </div>
              ...
              <div className="p-2">
                ...
                that the content posted is not owned or generated by 4dchan.org, but
                rather by 4dchan.org's users.
              </div>
