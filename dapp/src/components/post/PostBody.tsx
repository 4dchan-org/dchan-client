...
export default function PostBody({post, style = {}}: {style?: any, post: Post}) {
  ...
  let __html = sanitized
    ...
    .replace(REF_HTML_SAFE_REGEX, `<a href="#/$1" class="${refClasses}" style="${refStyle}"><u>&gt;&gt;$1$2</u></a>`) // 0x refs
    .replace(REF_POST_HTML_SAFE_REGEX, `<a href="#${baseUrl}$1" class="${refClasses}" style="${refStyle}"><u>&gt;&gt;$1$2</u></a>`) // Post refs
    .replace(REF_BOARD_HTML_SAFE_REGEX, `<a href="#/$2" class="${refClasses}" style="${refStyle}"><u>&gt;&gt;$1$3</u></a>`) // Board refs
    .replace(BACKLINK_HTML_SAFE_REGEX, `<a class="${refClasses}" style="${refStyle}" href="#${baseUrl}$1"><u>&gt;&gt;$1$2</u></a>`) // Post backlinks // @HACK
